...
Welcome to the `lib_c` repository — a standard C library wrapper, part of the Programming 101 C library collection. This guide will help you set up, build, and install the library.

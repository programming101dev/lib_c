 ...
 * @return
 */
int p101_memcmp(const struct p101_env *env, const void *s1, const void *s2,
              size_t n);
 ...
 * @return
 */
void *p101_memcpy(const struct p101_env *env, void *restrict s1,
 ...
 * @return
 */
void *p101_memmove(const struct p101_env *env, void *s1, const void *s2,
                 size_t n);
